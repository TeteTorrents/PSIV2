...
for fold, (train_index, val_index) in enumerate(kf.split(ds)):
    ...
    print("Training Set:")
    print("REAL:")
    print(train_patient_label)
    print("PREDICCIO:")
    print(train_patient_label_prediction)
    print("PERCENTATGES NORMAL:")
    print(train_percentatge_positius)
    print("PERCENTATGES ORIGINAL:")
    print(train_label_original)
    print("TOT")
    print(train_per_or)
    ...
    print("REAL:")
    print(val_patient_label)
    print("PREDICCIO:")
    print(val_patient_label_prediction)
    print("PERCENTATGES NORMAL:")
    print(val_percentatge_positius)
    print("PERCENTATGES ORIGINAL:")
    print(val_label_original)
    print("TOT")
    print(val_per_or)
