...
dataset = WindowLevel(data_dir=r'/fhome/mapsiv02/Desktop/projecte_epil/data/annotated_windows', split_level='patient')
...
for fold, (train_index, val_index) in enumerate(skf.split(X, y, grups)):
    ...
    val_loader = torch.utils.data.DataLoader(val_subset, batch_size=1024, shuffle=False)
...
torch.save(lstm_model.state_dict(), 'transformer_model_patient.pth')
