...
def train_model(model, data_loader_train, data_loader_test, loss_fn, optimizer, epochs=10, lr=0.001):
    # train the model
...
if __name__ == '__main__':
    ...
    for fold, (train_index, val_index) in enumerate(skf.split(X)):
        ...
        metrics = train_model(model, train_data_loader, val_data_loader, loss_fn, optimizer, epochs=EPOCHS, lr=LR)
        models.append(model)
